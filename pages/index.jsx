  ...
  return (
    <div className="">
      ...
      <main className="container">
        <div className="flex w-10/12 justify-evenly items-center mt-3 sm:mt-8 lg:mt-24  m-auto p-5">
          <div className="text-center">
            ...
            <p className="text-gray-600 mt-4">Road Transportation and Traffics made easier</p>
            <div>
              <img src="/imgs/img1.jpg" className="w-8/12 inline-block mt-16 rounded-lg" alt=""/>
            </div>
          </div>
          ...
          <section>
            ...
            >
              <div className="text-center mb-5">
                ...
                <h2 className="text-xl text-gray-400">User Login</h2>
              </div>
